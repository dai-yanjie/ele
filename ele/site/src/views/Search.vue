<template>
    <div class="search">
        <!--头部-->
        <EleHeader>
            <h1 class="header-title" style="color:red;">搜索</h1>
        </EleHeader>
        ...
        <div class="shop">
            <div v-if="$store.state.shop.searchShopList.length<1" class="empty_wrap">
